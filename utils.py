...
__repo__ = "https://github.com/Swethainiyan/Movie-Time-Filter"
__version__ = "Movie-Time-Filter ᴠ4.5.0"
__license__ = "GNU GENERAL PUBLIC LICENSE V2"
__copyright__ = "Copyright (C) 2023-present Kumaresan J<https://github.com/Swethainiyan>"
